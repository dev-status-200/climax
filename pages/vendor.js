...
import Vendor from '../Components/Layouts/Vendor';

const vendor = ({sessionData, representativeData, vendorData}) => {
  return (
    <Vendor sessionData={sessionData} representativeData={representativeData} vendorData={vendorData} />
  )
}
...
export async function getServerSideProps({req,res}){
    ...
    return{
        props: { sessionData:sessionRequest, representativeData:representativesRequest, vendorData:vendorsRequest }
    }
  }